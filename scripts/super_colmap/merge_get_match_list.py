...
def merge_get_match_list(fold_path):
    #得到内部的匹配对
    ref_poses,merge_poses = get_image_snapshot_pose_extri(fold_path)
    ...
    match_list = []
    get_points(fold_path,ref_match_list)
...
if __name__ == '__main__':
    fold_path = '/dataset/sfm/dataset/ref_EP41-ORIN-0S14-00G_EP41_ORIN_02.10.09_1225_20231101-025107_39_1.mcap_merge_EP41-ORIN-0S14-00G_EP41_ORIN_02.10.09_1225_20231101-025107_39_2.mcap/sfm'
    merge_get_match_list(fold_path)
    #ref_poses,merge_poses = get_image_snapshot_pose_extri(fold_path)
